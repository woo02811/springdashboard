...
public class Page {
	...
	/*
	 * private String SsearchTK; public void setSearchTypeKeyword(String
	 * searchType,String keyword){ if(searchType.equals("")|| keyword.equals("")) {
	 * SsearchTK = "/"; } else { SsearchTK =
	 * "&searchType="+searchType+"&keyword="+keyword; }
	 * System.out.println("-------------------"); System.out.println(SsearchTK);
	 * System.out.println("-------------------");
	 * 
	 * 
	 * } public String getsearchTK() { return SsearchTK; }
	 */
}
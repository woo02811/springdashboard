			...
			<div class="modal-content">
				<div class="modal-header modal-header-info">
					...
					<h4 class="modal-title">
						<span class="glyphicon glyphicon-pencil"></span> Modify Posting
					</h4>
				</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="writerIn"
									name="writer" placeholder="writer" value="${view.writer}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="titleIn"
									name="title" placeholder="Title" value="${view.title}">
							</div>
						</div>
						<div class="form-group">
